...
*
* Solution #
Another way of defining the rotation is to take the sub-list of ‘k’ ending nodes of the LinkedList and connect them to
* the beginning. Other than that we have to do three more things:
