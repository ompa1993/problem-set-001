...
* element which is bigger than its previous element, will sorting the subarray between these two numbers result in the
...
public class ShortestWindowSort {
    ...
    public static int sort(int[] arr) {
        ...
        //now low an high indexs are where orders break
